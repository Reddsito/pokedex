...
var PokemonService = /** @class */ (function () {
    function PokemonService(pokemonModel) {
    ...
    PokemonService.prototype.findAll = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.pokemonModel.findOne({ no: term })];
                    case 1:
                        pokemon = _a.sent();
                        _a.label = 2;
                    case 2:
                        if (!(!pokemon && (0, mongoose_2.isValidObjectId)(term))) return [3 /*break*/, 4];
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, this.pokemonModel.findOne({
                    ...
                    case 6:
                        if (!pokemon)
                            throw new common_1.NotFoundException("Pokemon with id, name or no \"".concat(term, "\" not found"));
                        return [2 /*return*/, pokemon];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, pokemon.updateOne(updatePokemonDto, { "new": true })];
                    case 3:
                        _a.sent();
    ...
    PokemonService.prototype.handleExceptions = function (error) {
        if (error.code === 11000)
            throw new common_1.BadRequestException("Pokemon exists in db ".concat(JSON.stringify(error.keyValue)));
        console.log(error);
